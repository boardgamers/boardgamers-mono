...
;type $$ComponentProps =  { data: { featured: LoadGamesResult; lobby: LoadGamesResult; boardgameId: string | undefined } };function $$render() {
...
async () => {
 ...
 { const $$_OES0C = __sveltets_2_ensureComponent(SEO); new $$_OES0C({ target: __sveltets_2_any(), props: {    "title":`All games`,"description":`${featuredCount} ongoing games and ${lobbyCount} open games.`,}});}
