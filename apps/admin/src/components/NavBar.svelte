<script lang="ts">
	...
	let { user, onMenuClick }: { user: UserFront & { _id: string }; onMenuClick?: () => void } = $props();
...
>
	<button
		onclick={onMenuClick}
		class="p-2 -ml-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 text-gray-500 md:hidden"
		title="Open menu"
